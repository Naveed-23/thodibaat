...
export default function Waitlist() {
  ...
  return (
    <div className="flex justify-center mt-24 items-center min-h-screen bg-gradient-to-b from-blue-400 to-white p-6">
      <div className="bg-white shadow-lg rounded-xl px-8 py-8 max-w-6xl w-full text-center">
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex pb-4">
          ...
          <button
            type="submit"
            className="ml-3 px-6 py-3 cursor-pointer bg-blue-600 text-white font-semibold rounded-md shadow hover:bg-blue-700 transition-all"
          >
            Join
          </button>
        </form>
