...
export default function HeroSectionOne() {
  ...
  return (
    <div className="relative mx-auto flex max-w-7xl flex-col items-center justify-center px-6 md:px-12 lg:flex-row lg:justify-between">
      <Navbar />

      {/* Left Section - Text */}
      <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
        <h1 className="relative z-10 max-w-4xl text-2xl font-bold text-black md:text-5xl lg:text-6xl">
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-6 py-4 backdrop-blur-lg">
      ...
      <div className="flex items-center gap-4">
        <Link
          href={"#"}
          className="w-20 transform font-medium text-black transition-all duration-300 hover:-translate-y-0.5"
        >
          Features
        </Link>
        <Link
          href={"#"}
          className="w-12 transform font-medium text-black transition-all duration-300 hover:-translate-y-0.5"
        >
          FAQ
        </Link>
